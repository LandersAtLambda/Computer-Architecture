...
-   Make a list of files here.
    ...
    -   cpu.c - Set on instructions is hard coded. Main logic for the emulator
    -   cpu.h - helper file that adds definitions
    -   ls8.c - main file that is executed and runs the functions
    -
